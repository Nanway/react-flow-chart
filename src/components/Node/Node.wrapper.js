...
exports.NodeWrapper = function (_a) {
    ...
    return (React.createElement(react_draggable_1.default, { bounds: "parent", axis: "both", position: node.position, grid: [1, 1], onStart: onStart, onDrag: onDrag, disabled: config.readonly, cancel: ".shadowrealm" },
